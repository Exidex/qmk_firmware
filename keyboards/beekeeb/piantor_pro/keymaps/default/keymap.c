...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV_LAYER_MACOS] = LAYOUT_split_3x6_3(
        ...
        _______,    _______,    _______,    _______,        _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    KC_F19,        _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,

        _______, _______, _______,                _______, _______, _______
    ),

    [SYMBOL_LAYER] = LAYOUT_split_3x6_3(
        KC_EXLM,    KC_AT,       KC_7,    KC_8,    KC_9,    KC_AMPR,                             KC_GRV,    KC_MINUS,   KC_LPRN,    KC_RPRN,    XXXXXXX,    KC_PIPE,
        KC_HASH,    KC_DLR,      KC_4,    KC_5,    KC_6,    KC_0,                                KC_DQUO,   KC_UNDS,    KC_LCBR,    KC_RCBR,    XXXXXXX,    KC_TILDE,
        KC_PERC,    KC_CIRC,     KC_1,    KC_2,    KC_3,    KC_ASTR,                             KC_QUOT,   KC_EQL,     KC_LBRC,    KC_RBRC,    KC_BSLS,    KC_PLUS,
    ...
    [MOD_LAYER_LEFT] = LAYOUT_split_3x6_3(
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    OSM_GUI,    OSM_LALT,   OSM_CTRL,   OSM_SHFT,     OSM_RALT,            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
    ...
    [MOD_LAYER_RIGHT] = LAYOUT_split_3x6_3(
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    OSM_SHFT,   OSM_CTRL,   OSM_LALT,    OSM_GUI,    _______,
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
    ...
    [MOD_LAYER_MACOS_LEFT] = LAYOUT_split_3x6_3(
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    OSM_CTRL,   OSM_LALT,   OSM_GUI,    OSM_SHFT,     OSM_RALT,            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
    ...
    [MOD_LAYER_MACOS_RIGHT] = LAYOUT_split_3x6_3(
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    OSM_SHFT,   OSM_GUI,    OSM_LALT,    OSM_CTRL,    _______,
        _______,    _______,    _______,    _______,    _______,      _______,            _______,    _______,    _______,    _______,    _______,    _______,
