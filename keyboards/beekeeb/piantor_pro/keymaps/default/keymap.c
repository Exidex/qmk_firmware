...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYMBOL_LAYER] = LAYOUT_split_3x6_3(
        KC_EXLM,    KC_AT,       KC_7,    KC_8,    KC_9,    KC_AMPR,                             KC_GRV,    KC_LPRN,    KC_RPRN,    XXXXXXX,    XXXXXXX,    KC_PIPE,
        KC_HASH,    KC_DLR,      KC_4,    KC_5,    KC_6,    KC_0,                                KC_QUOT,   KC_MINUS,   KC_UNDS,    KC_LCBR,    KC_RCBR,    KC_TILDE,
        KC_PERC,    KC_CIRC,     KC_1,    KC_2,    KC_3,    KC_ASTR,                             KC_DQUO,   KC_LBRC,    KC_RBRC,    KC_EQL,     KC_BSLS,    KC_PLUS,
